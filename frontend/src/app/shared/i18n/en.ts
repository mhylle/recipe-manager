...
export const en = {
  ...
  'recipe.detail.signInToEdit': 'Sign in to edit this recipe.',
  ...
  'dashboard.kitchenLocked': 'Sign in to see what you can cook from your kitchen. The recipe library is below either way.',
