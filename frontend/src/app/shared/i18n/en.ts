...
export const en = {
  ...
  'pantry.state.signIn': 'Sign in at mhylle.com to see your kitchen.',
  ...
  'dashboard.kitchenLocked': 'Sign in at mhylle.com to see what you can cook from your kitchen. The recipe library is below.',
