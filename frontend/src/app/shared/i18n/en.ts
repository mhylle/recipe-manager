...
export const en = {
  ...
  'reports.statusInProgress': 'Being worked on',
  'reports.statusClosed': 'Done',
  'reports.columnIdeas': 'Ideas ({{count}})',
  'reports.columnDefects': 'Defects ({{count}})',
  'reports.noIdeas': 'No ideas reported yet.',
  'reports.noDefects': 'No defects reported yet.',
  ...
  'recipe.sort.ratingDesc': 'Highest rated',
  'recipe.sort.likesDesc': 'Most liked',
  'recipe.reactions.like': 'Like',
  'recipe.reactions.likeCount': '{{count}} likes',
  'recipe.reactions.rateLegend': 'Your rating out of five',
  'recipe.reactions.starsOf': '{{stars}} of 5 stars',
  'recipe.reactions.clearRating': 'Clear',
  'recipe.reactions.average': '{{average}} from {{count}}',
  'recipe.reactions.unrated': 'Not rated yet',
  'recipe.filters.likedOnly': 'Only my favourites',
  ...
  'recipe.form.tagsMainHint':
    'A recipe with no course marked still counts as a main course. Add anything else you like below, separated by commas.',
  ...
  'recipe.variations.editor.empty': 'No variations yet.',
  'recipe.variations.editor.add': 'Add a variation',
  'recipe.variations.editor.afterSave':
    'Save the recipe first, then you can add the other ways to cook it.',
  'recipe.variations.editor.untitled': 'Unnamed variation',
  'recipe.variations.editor.tally':
    '{{shared}} shared · {{changed}} changed · {{skipped}} skipped · {{inserted}} added',
  'recipe.variations.editor.removeVariation': 'Remove the variation {{name}}',
  'recipe.variations.editor.name': 'Name',
  'recipe.variations.editor.namePlaceholder': 'e.g. 10 g yeast — same day',
  'recipe.variations.editor.nameRequired': 'Give it a name, or it cannot be chosen.',
  'recipe.variations.editor.nameMissingHere': 'Not named in this language yet.',
  'recipe.variations.editor.note': 'Why cook it this way',
  'recipe.variations.editor.notePlaceholder': 'The quickest. Two to four hours.',
  'recipe.variations.editor.prepTime': 'Prep time (min)',
  'recipe.variations.editor.cookTime': 'Cook time (min)',
  'recipe.variations.editor.inherits': "The recipe's own",
  'recipe.variations.editor.ingredients': 'Ingredients',
  'recipe.variations.editor.ingredientsHint':
    'Change only what this version uses differently. Anything you do not touch is bought and measured as the recipe says.',
  'recipe.variations.editor.sharedIngredient': '{{name}} — {{quantity}} {{unit}}',
  'recipe.variations.editor.changeIngredientLabel': 'Change how much {{name}} this version uses',
  'recipe.variations.editor.dropIngredientLabel': 'Leave {{name}} out of this version',
  'recipe.variations.editor.droppedIngredient': '{{name}} — left out',
  'recipe.variations.editor.quantityLabel': 'How much {{name}}',
  'recipe.variations.editor.unitLabel': 'Unit for {{name}}',
  'recipe.variations.editor.leaveOut': 'Leave out',
  'recipe.variations.editor.putBack': 'Put back',
  'recipe.variations.editor.addIngredient': 'Add an ingredient this version needs',
  'recipe.variations.editor.addedNamePlaceholder': 'e.g. Sugar',
  'recipe.variations.editor.addedNameLabel': 'Name of the added ingredient',
  'recipe.variations.editor.addedQuantityLabel': 'How much of the added ingredient',
  'recipe.variations.editor.addedUnitLabel': 'Unit for the added ingredient',
  'recipe.variations.editor.addedCategoryLabel': 'Shelf for the added ingredient',
  'recipe.variations.editor.method': 'Method',
  'recipe.variations.editor.methodHint':
    'Every step below belongs to the recipe. Change one only where this version really is done differently — the rest are written once and read by all of them.',
  'recipe.variations.editor.stepSummary':
    '{{shared}} of {{total}} steps shared, {{changed}} changed, {{skipped}} skipped',
  'recipe.variations.editor.change': 'Change',
  'recipe.variations.editor.revert': 'Back to shared',
  'recipe.variations.editor.skip': 'Skip',
  'recipe.variations.editor.changeStepLabel': 'Change step {{number}} for this version',
  'recipe.variations.editor.skipStepLabel': 'Skip step {{number}} in this version',
  'recipe.variations.editor.changedStepLabel': 'Step {{number}}, as this version does it',
  'recipe.variations.editor.insertHere': 'Add a step here',
  'recipe.variations.editor.insertedBadge': 'Extra step',
  'recipe.variations.editor.insertedPlaceholder': 'What this version does here',
  'recipe.variations.editor.insertedLabel': 'The added step',
  ...
  'mealPlan.view.label': 'How to show the week',
  'mealPlan.view.compact': 'Compact',
  'mealPlan.view.visual': 'Visual',
  'mealPlan.move': 'Move',
