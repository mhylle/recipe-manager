...
export const en = {
  ...
  'register.passwordRule': 'At least 6 characters, including a number. Letters and numbers only \u2014 no symbols.',
  ...
  'register.errPasswordWeak': 'Use at least 6 characters, including a number.',
  'register.errPasswordCharset': 'Passwords can only use letters and numbers \u2014 no punctuation or symbols. That is a limitation of the mhylle.com account system, not a choice we made.',
